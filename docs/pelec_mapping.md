...
| AMReX distributed-box responsibility | `mpi_domain_1d_mod`, `mpi_reactive_transport_1d_mod`, `mpi_reactive_1d_mod`, `mpi_amr_patch_1d_mod`, `mpi_amr_sparse_patch_1d_mod` | Uneven 1D blocks, subcycle-weighted AMR owner maps, rank-local stability limits and storage, broadcast-free sparse physics, direct owner migration, halos, parent/child state and flux traffic, and field-sparse explicit/tag-driven topology rebuilds verified for 1/2/4/8 ranks |

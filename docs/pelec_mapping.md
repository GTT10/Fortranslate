...
| AMReX distributed-box responsibility | `mpi_domain_1d_mod`, `mpi_reactive_transport_1d_mod`, `mpi_reactive_1d_mod`, `mpi_amr_patch_1d_mod`, `mpi_amr_sparse_patch_1d_mod` | Uneven 1D blocks, owner-only tree physics with transactional rollback, rank-local AMR payload storage, exact scatter/gather, and same-hierarchy owner migration verified for 1/2/4/8 ranks; direct sparse physics and point-to-point schedules remain pending |

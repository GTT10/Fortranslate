...
| `Source/PeleCAmr.*` hierarchy/synchronization subset | `amr_hierarchy_1d_mod` | Static 1D two-level boxes, prolongation, restriction, subcycling, flux register, and reflux verified; tagging/regrid/multilevel pending |

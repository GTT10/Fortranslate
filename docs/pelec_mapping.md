...
| AMReX distributed-box responsibility | `mpi_domain_1d_mod`, `mpi_reactive_transport_1d_mod`, `mpi_reactive_1d_mod`, `mpi_amr_patch_1d_mod`, `mpi_amr_sparse_patch_1d_mod` | Uneven 1D blocks, rank-local AMR storage, full sparse physics, point-to-point owner migration, adjacent halos, and child-to-parent interiors, plus explicit/tag-driven topology rebuilds verified for 1/2/4/8 ranks; remaining parent/child interval and flux schedules are collective |

...
| `Source/PeleCAmr.*` hierarchy/synchronization subset | `amr_hierarchy_1d_mod`, `amr_regrid_1d_mod` | 1D two-level boxes, transfers, subcycling, reflux, gradient tagging, and conservative single-patch regridding verified; multilevel pending |

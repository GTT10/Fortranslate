...
| AMReX distributed-box responsibility | `mpi_domain_1d_mod`, `mpi_reactive_transport_1d_mod`, `mpi_reactive_1d_mod`, `mpi_amr_patch_1d_mod`, `mpi_amr_sparse_patch_1d_mod` | Uneven 1D blocks, rank-local AMR storage, broadcast-free sparse physics, direct owner migration, halos, parent/child state and flux traffic, and replica-free explicit topology rebuilds verified for 1/2/4/8 ranks; tag planning still uses a temporary field replica |
| `Source/PeleCAmr.*` hierarchy/synchronization subset | `amr_hierarchy_1d_mod`, `amr_multipatch_1d_mod`, `amr_patch_tree_1d_mod`, `amr_patch_tree_reactive_1d_mod`, `amr_regrid_1d_mod`, `amr_reactive_1d_mod`, `amr_multilevel_reactive_1d_mod`, `amr_multipatch_reactive_1d_mod`, `mpi_amr_patch_1d_mod`, `mpi_amr_sparse_patch_1d_mod` | Runnable solution-driven arbitrary-depth branching, adjacent sibling exchange, complete sparse physics, and direct explicit topology migration; tag-driven planning still uses a temporary correctness replica |

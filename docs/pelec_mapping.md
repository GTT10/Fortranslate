...
| AMReX distributed-box responsibility | `mpi_domain_1d_mod`, `mpi_reactive_transport_1d_mod`, `mpi_reactive_1d_mod`, `mpi_amr_patch_1d_mod`, `mpi_amr_sparse_patch_1d_mod`, `mpi_amr_eb_patch_2d_mod` | Uneven 1D blocks, subcycle-weighted 1D/EB AMR owner maps, rank-local 1D stability limits and storage, broadcast-free sparse 1D physics, direct 1D owner migration and traffic, plus replicated 2D EB root-tile/child synchronization and owner-only active-cell chemistry verified for 1/2/4/8 ranks |

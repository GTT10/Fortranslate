...
| AMReX distributed-box responsibility | `mpi_domain_1d_mod`, `mpi_reactive_transport_1d_mod`, `mpi_reactive_1d_mod`, `mpi_amr_patch_1d_mod`, `mpi_amr_sparse_patch_1d_mod` | Uneven 1D blocks, rank-local AMR storage, broadcast-free sparse physics, direct owner migration, halos, parent/child state and flux traffic, plus explicit/tag-driven topology rebuilds verified for 1/2/4/8 ranks; regrid still uses a temporary all-rank correctness replica |

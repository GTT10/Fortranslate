...
| Sparse MPI EB AMR responsibility | PeleF 0.153.0 |
|---|---|
...
| arbitrary-depth EB numerical tree | runtime relation sequence with ordered parent/child offsets, branching, per-level refinement ratios, transactional whole-tree state migration, composite integration, and all-node hyperbolic CFL reduction; physics advancement and MPI ownership remain future work |

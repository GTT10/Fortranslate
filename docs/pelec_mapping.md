...
| `Source/EB.*`, `pc_umdrv_eb`, and AMReX-Hydro redistribution | `eb_geometry_2d_mod`, `eb_reactive_wall_flux_2d_mod`, `eb_reactive_redistribution_2d_mod`, `eb_reactive_reconstruction_2d_mod`, `eb_reactive_hydro_2d_mod`, `reactive_eb_2d_driver_mod`, `pelef_reactive_eb_2d` | Nodal geometry with cell/face centroids, reactive slip-wall pressure flux, PCM or active-stencil characteristic-PLM face-center Godunov fluxes, tangential interpolation to open-face centroids, FluxRedist, selectable zeroth- or second-order weighted StateRedist, active-cell chemistry splitting, and an input-driven serial time loop with EOS-validated transactions verified; unsplit EB transverse prediction, fourth-order StateRedist, periodic/ghost neighborhoods, molecular transport, AMR, and MPI remain |

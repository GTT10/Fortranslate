program test_entropy_wave_pelec
  ...
  do case_index = 1, number_of_resolutions
    ...
    if (.not. ok) error stop "PeleC-flux entropy-wave run failed"
  ...
  write(*, '(a)') "test_entropy_wave_pelec: PASS"
...
end program test_entropy_wave_pelec

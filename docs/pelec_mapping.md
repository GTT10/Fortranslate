...
| AMReX distributed-box responsibility | `mpi_domain_1d_mod`, `mpi_reactive_transport_1d_mod`, `mpi_reactive_1d_mod`, `mpi_amr_patch_1d_mod`, `mpi_amr_sparse_patch_1d_mod` | Uneven 1D blocks, rank-local AMR storage and migration, and direct sparse chemistry, hydro, and molecular transport verified for 1/2/4/8 ranks; sparse full-physics composition and point-to-point schedules remain pending |

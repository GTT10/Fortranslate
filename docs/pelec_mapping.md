...
| AMReX distributed-box responsibility | `mpi_domain_1d_mod`, `mpi_reactive_transport_1d_mod`, `mpi_reactive_1d_mod`, `mpi_amr_patch_1d_mod`, `mpi_amr_sparse_patch_1d_mod` | Uneven 1D blocks, owner-only replicated tree physics, rank-local AMR payload storage and migration, and direct sparse chemistry with distributed synchronization verified for 1/2/4/8 ranks; sparse hydro/transport and point-to-point schedules remain pending |
| `Source/PeleCAmr.*` hierarchy/synchronization subset | `amr_hierarchy_1d_mod`, `amr_multipatch_1d_mod`, `amr_patch_tree_1d_mod`, `amr_patch_tree_reactive_1d_mod`, `amr_regrid_1d_mod`, `amr_reactive_1d_mod`, `amr_multilevel_reactive_1d_mod`, `amr_multipatch_reactive_1d_mod`, `mpi_amr_patch_1d_mod`, `mpi_amr_sparse_patch_1d_mod` | Runnable tag-driven arbitrary-depth branching trees, dynamic rebuilds, adjacent sibling exchange, deterministic MPI ownership, complete owner-only physics, sparse patch payloads, and same-hierarchy ownership migration; topology-changing distributed regrid remains pending |

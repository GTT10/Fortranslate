...
| reactive hydro state/flux path | `reactive_1d_mod`, `pelef_reactive_1d` | NASA7 conversion, selectable Rusanov/HLLC flux, characteristic PLM, and Strang splitting verified |
